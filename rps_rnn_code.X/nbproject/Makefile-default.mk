...
${OBJECTDIR}/model_weights.o: model_weights.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/model_weights.o.d 
	@${RM} ${OBJECTDIR}/model_weights.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=attiny1614  -I "E:\Program Files (x86)\Microchip\MPLABX\v5.20\packs\Microchip\ATtiny_DFP\2.0.10\include"  -B "E:\Program Files (x86)\Microchip\MPLABX\v5.20\packs\Microchip\ATtiny_DFP\2.0.10\gcc\dev\attiny1614" -g -DDEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O2 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/model_weights.o.d" -MT "${OBJECTDIR}/model_weights.o.d" -MT ${OBJECTDIR}/model_weights.o  -o ${OBJECTDIR}/model_weights.o model_weights.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
	
${OBJECTDIR}/model.o: model.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/model.o.d 
	@${RM} ${OBJECTDIR}/model.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=attiny1614  -I "E:\Program Files (x86)\Microchip\MPLABX\v5.20\packs\Microchip\ATtiny_DFP\2.0.10\include"  -B "E:\Program Files (x86)\Microchip\MPLABX\v5.20\packs\Microchip\ATtiny_DFP\2.0.10\gcc\dev\attiny1614" -g -DDEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O2 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/model.o.d" -MT "${OBJECTDIR}/model.o.d" -MT ${OBJECTDIR}/model.o  -o ${OBJECTDIR}/model.o model.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
